...
class DogCardAdapter(
    ...
    val dogData: List<Dog> = DataSource.dogs
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val layoutId: Int = if (viewType == Layout.GRID) R.layout.grid_list_item
    ...
    override fun getItemCount() = dogData.size // TODO: return the size of the data set instead of 0

    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        // TODO: Get the data at the current position
        val dog = dogData[position]
